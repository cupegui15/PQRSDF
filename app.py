...
# ==================================================
# 📧 NOTIFICACIONES CON FIRMA BASE64
# ==================================================
    ...
    if st.button("📨 Enviar Notificaciones"):
        ...
        df_notif = df_notif[df_notif['Estado'].str.lower() == "en proceso"]
        ...
        for area in areas:
            ...
            msg['Cc'] = "cristian.upegui@urosario.edu.co"
